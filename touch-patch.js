...
`;
    ...
    async function installUniversalImporter() {
        ...
        const runUniversalUpload = function () {
            ...
            showImportBanner(
                `Lendo ${file.name} com importador universal...`
            );
        ...
        if (
            ...
            if (
                ...
                badge.title =
                    "Importador universal JSON UI ativo";
...
/* RAG TOUCH PATCH BUILD: V9-FILE-PICKER */
window.__RAG_TOUCH_PATCH_BUILD__ = "v9-file-picker";
