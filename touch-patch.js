...
(() => {
    ...
    window.__RAG_TOUCH_PATCH_BUILD__ = "v25-border-system";

    const BUILD = "v25-border-system";
    ...
    async function createAutoHeaderAndBorder(
        ...
        if (
            ...
            showBanner(
                "Nao achei um border.png + border.json compatível. Importe a pasta ui completa.",
                "error"
            );
