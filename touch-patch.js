...
(() => {
    ...
    window.__RAG_TOUCH_PATCH_BUILD__ = "v12-panel-frame";

    const BUILD = "v12-panel-frame";
    ...
    async function updatePropertyExtras() {
        ...
        if (panelInstance) {
            ...
            if (oldPanelTools?.dataset.id !== panelId) {
                ...
                hint.textContent =
                    "Prender filhos usa clips_children no JSON. A moldura é uma textura 9-slice real e vai para o pack.";
