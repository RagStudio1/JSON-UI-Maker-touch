...
(() => {
    ...
    window.__RAG_TOUCH_PATCH_BUILD__ = "v21-native-sidecar-restore";

    const BUILD = "v21-native-sidecar-restore";
    ...
    // ============================================================
    // GRID V20 - single active grid, correct select/deselect lifecycle
    // ============================================================
    ...
    function patchGridSystem(mods) {
        ...
        shared.grid = function (
            ...
            // Show Grid means ONE grid only.
            // This also prevents stale parent grids accumulating.
            showOnlyGrid(
                classElement
            );
        };
        ...
        shared.select = function (
            ...
            // originalSelect toggles selection when tapping the same item.
            // Inspect final state instead of assuming it was selected.
            if (
                classElement?.selected &&
                mods.config.settings
                    .show_grid?.value &&
        ...
        shared.unSelect = function (
            ...
            // Deselect means no persistent grid at all.
            hideAllGrids();
        ...
        shared.stopDrag = function (
            ...
            // During drag the original editor may show the parent's grid.
            // Once the drag ends, kill that temporary parent grid and restore
            // only the selected element's own grid.
            restoreSelectedGrid(
                classElement
            );
        ...
        // Scrub any stale grid left by an older cached patch on startup.
        hideAllGrids();

        window.__RAG_GRID_V20__ = {
